"""
Modular training script for medical image segmentation.
Organized into classes for better maintainability and reusability.
"""
...
# Force CPU execution to avoid GPU PTX compilation issues
try:
...
class ConfigurationManager:
    """Manages configuration loading and training config creation."""
